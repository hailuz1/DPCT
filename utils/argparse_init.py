...
def init_parse_argparse_default_params(parser, dataset_name=None, arch=None):
    ...
    DATASET_OPTIONS = {"shape_corr": ["shrec"], "complition": []} #hai surreal
    parser.add_argument(
        "--dataset_name",
        type=str,
    ...
    parser.add_argument("--model_type_for_encoder", default='PCT', help="model type for encoder (DGCNN or PCT")
    parser.add_argument('--dropout_PCT', type=float, default=0.5, help='dropout rate')
