...
def main():
    ...
    #hparams.resume_from_checkpoint = '/home/haii/DPCT/output/shape_corr/DeepPointCorr/arch_DeepPointCorr/dataset_name_shrec/latent_dim_768/30_06:19:59:22/epoch=99.ckpt' #hai
    #hparams.do_train = False #hai
    #hparams.similarity_init = 'angular_distance'
    #hparams.show_vis = True #hai
...
def main_train(model_class_pointer, hparams,parser):
    ...
    trainer = pl.Trainer(
        ...
        benchmark=True,  
        gpus= [0,1],  # if not hparams.DEBUG_MODE else 1,
